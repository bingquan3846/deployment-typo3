...
return [
    'packages' => [
        ...
        'bgm_theme_bgm' => [
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/bgm_theme_bgm/',
            'suggestions' => [],
            'composerName' => 'bgm_theme_bgm',
        ],
        'gridelements' => [
        ...
        'image_autoresize' => [
            'composerName' => 'causal/image_autoresize',
            'state' => 'active',
        ...
        'page_speed' => [
            'composerName' => 'georgringer/page_speed',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/page_speed/',
            'suggestions' => [],
        ],
        'powermail' => [
            'state' => 'active',
        ...
        't3monitoring_client' => [
            'composerName' => 't3monitor/t3monitoring_client',
            'state' => 'active',
        ...
        'mr_tinypng' => [
            'composerName' => 'mr/mr_tinypng',
            'state' => 'inactive',
            'packagePath' => 'typo3conf/ext/mr_tinypng/',
            'suggestions' => [],
        ],
        'opendocs' => [
