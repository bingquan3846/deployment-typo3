...
$GLOBALS['TYPO3_CONF_VARS']['BE']['cookieDomain'] = '.###CI_BUILD_REF_NAME###.review.mtug.bgm-hosting.com';
$GLOBALS['TYPO3_CONF_VARS']['BE']['cookieName'] = 'be_typo_user_review_###CI_BUILD_REF_NAME###';
...
$GLOBALS['TYPO3_CONF_VARS']['DB']['database'] = 'www1_mtug_review';
$GLOBALS['TYPO3_CONF_VARS']['DB']['username'] = 'mtug';
$GLOBALS['TYPO3_CONF_VARS']['DB']['password'] = 'mtug';

$GLOBALS['TYPO3_CONF_VARS']['FE']['cookieDomain'] = '.###CI_BUILD_REF_NAME###.review.mtug.bgm-hosting.com';
$GLOBALS['TYPO3_CONF_VARS']['FE']['cookieName'] = 'fe_typo_user_review_###CI_BUILD_REF_NAME###';
...
$GLOBALS['TYPO3_CONF_VARS']['SYS']['cookieDomain'] = '.###CI_BUILD_REF_NAME###.review.mtug.bgm-hosting.com';
//$GLOBALS['TYPO3_CONF_VARS']['SYS']['devIPmask'] = '*';
//$GLOBALS['TYPO3_CONF_VARS']['SYS']['displayErrors'] = true;
//$GLOBALS['TYPO3_CONF_VARS']['SYS']['enableDeprecationLog'] = 'file';
$GLOBALS['TYPO3_CONF_VARS']['SYS']['sitename'] = 'MTUG Internet Review ###CI_BUILD_REF_NAME### (' . php_uname(n) . ')';
//$GLOBALS['TYPO3_CONF_VARS']['SYS']['sqlDebug'] = 1;
//$GLOBALS['TYPO3_CONF_VARS']['SYS']['systemLogLevel'] = 0;
$GLOBALS['TYPO3_CONF_VARS']['SYS']['trustedHostsPattern'] = '###CI_BUILD_REF_NAME###\.review\.mtug\.bgm-hosting\.com';
